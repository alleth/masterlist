<?php
include 'DAO/software-config-DAO.php';
    ...
    switch ($_POST['action']) {
        ...
        case 'updateHardware':
            if (isset($_POST['hw_asset_num'], $_POST['hw_serial_num'], $_POST['site_code'], $_POST['region_id'])) {
                $utilities = isset($_POST['utilities']) ? (is_array($_POST['utilities']) ? $_POST['utilities'] : json_decode($_POST['utilities'], true)) : [];
                echo json_encode($dao->updateHardware(
                    ...
                    isset($_POST['hw_primary_role']) ? $_POST['hw_primary_role'] : null,
                ...
                echo json_encode([
                    'success' => false,
                    'message' => 'Missing hw_asset_num parameter'
                ]);
            }
            break;
