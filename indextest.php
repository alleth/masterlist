...
<div class="container-fluid">
    ...
    <div id="allSiteCard" class="card shadow-sm mb-4">
     ...
     <!-- Hardware Aging Summary -->
    <div id="allSiteCard3" class="card shadow-sm mb-4">
        <div class="card-body">
            <!-- <div><i class="bi bi-server me-1"></i><strong>Hardware Aging</strong></div> -->

            <!--
                <div class="col-md-2 col-sm-4 col-6">
                    <div class="stat-box color-box3 text-center">
                        <div class="large-number" data-target="20">
                            <p class="card-text" id="5yearsYounger">0</p>
                        </div>
                        <div class="">5 Years Below</div>
                    </div>
                </div>
                ...
                <div class="col-md-2 col-sm-4 col-6">
                    <div class="stat-box color-box3 text-center">
                        <div class="large-number" data-target="20">
                            <p class="card-text" id="5yearsOlder">0</p>
                        </div>
                        <div class="">Older Thank 5 years</div>
                    </div>
                </div>
            -->
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <canvas id="hardwareAgingChart" height="200"></canvas>
                    </div>
                </div>
