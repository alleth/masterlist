...
?>
    ...
    <style>
        ...
        .accordion-item.has-warning .accordion-button .bi {
            color: #ffc107; /* Bootstrap warning color for the icon */
        }
    ...
    <main>
        <div class="container-fluid px-4">
            <h5 class="mt-3">Server Configuration</h5>
                    ...
                    <div class="card border border-dark-subtle shadow-sm">
                        <div class="card-body">
                            <div class="row g-2 align-items-center">
                                <div class="col-md-2">
                                    <select class="form-select" name="region_name" id="ServerRegionSelect">
                                        <option value="" selected>Select Region</option>
                                    </select>
                                </div>
                                <div class="col-md-2">
                                    <select class="form-select" name="site_name" id="ServerSiteSelect" disabled>
...
<?php include 'includes/components.php'; ?>
    <script src="js/select2-design.js?v=<?= time() ?>" type="text/javascript"></script>
